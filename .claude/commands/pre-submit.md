...
- [ ] No typos in company name, role title, or your own credentials
...
- [ ] Log the application in `applications/tracker.md` with: company, role, date applied, status, follow-up date
...
Ask the user: "Is there anything about this application that felt uncertain or off to you?"
